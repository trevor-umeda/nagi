...
class PhraseController {
    ...
    def save(Phrase phraseInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'phraseInstance.label', default: 'Phrase'), phraseInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'phraseInstance.label', default: 'Phrase'), params.id])
                redirect action: "index", method: "GET"
            }
