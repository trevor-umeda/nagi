	...
	<body>
		...
		<div id="show-phrase" class="content scaffold-show" role="main">
			...
			<ol class="property-list phrase">
				...
				<g:if test="${phraseInstance?.body}">
				<li class="fieldcontain">
					<span id="body-label" class="property-label"><g:message code="phrase.body.label" default="Body" /></span>
					
						<span class="property-value" aria-labelledby="body-label"><g:fieldValue bean="${phraseInstance}" field="body"/></span>
