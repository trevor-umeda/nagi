	...
	<body>
		...
		<div id="show-answer" class="content scaffold-show" role="main">
			...
			<ol class="property-list answer">
				...
				<g:if test="${answerInstance?.body}">
				<li class="fieldcontain">
					<span id="body-label" class="property-label"><g:message code="answer.body.label" default="Body" /></span>
					
						<span class="property-value" aria-labelledby="body-label"><g:fieldValue bean="${answerInstance}" field="body"/></span>
