		...
		<div id="list-answer" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="body" title="${message(code: 'answer.body.label', default: 'Body')}" />
				...
				<g:each in="${answerInstanceList}" status="i" var="answerInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${answerInstance.id}">${fieldValue(bean: answerInstance, field: "body")}</g:link></td>
